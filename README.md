...
**Consideraciones importantes**: El `archivo proyectos_simple.json` presenta para cada proyecto un "title" (identificador de la convocatoria con el título de la misma) y "full_content" (descripción de la convocatoria). Este archivo varía en función de qué proyectos queramos escoger, pero se puede obtener mediante scrapping de la web deseada. 
